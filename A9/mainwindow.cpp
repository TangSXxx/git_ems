...
void MainWindow::on_SystemOverviewButton_toggled(bool checked)
{
        if(checked)
        {
            ui->SystemOverviewButton->setIconSize(QSize(44,44));       //按下时放大icon大小
            ui->SystemOverviewButton->setFont(QFont("宋体",10,QFont::Bold));        //按下时更改字体格式：Qfont对象 字体 大小 加粗
            ui->SystemOverviewButton->setStyleSheet("QToolButton{background-color:rgb(0, 85, 127);color: rgb(255, 255, 255);}");
        }
        else
        {
            ui->SystemOverviewButton->setIconSize(QSize(40,40));
            ui->SystemOverviewButton->setFont(QFont("宋体",9,QFont::Bold));
...
void MainWindow::on_ConditionMonitorButton_toggled(bool checked)
{
    if(checked)
    {
        ui->ConditionMonitorButton->setIconSize(QSize(44,44));       //按下时放大icon大小
        ui->ConditionMonitorButton->setFont(QFont("宋体",10,QFont::Bold));        //按下时更改字体格式：Qfont对象 字体 大小 加粗
        ui->ConditionMonitorButton->setStyleSheet("QToolButton{background-color:rgb(0, 85, 127);color: rgb(255, 255, 255);}");
    }
    else
    {
        ui->ConditionMonitorButton->setIconSize(QSize(40,40));
        ui->ConditionMonitorButton->setFont(QFont("宋体",9,QFont::Bold));
...
void MainWindow::on_PCSManageButton_toggled(bool checked)
{
    if(checked)
    {
        ui->PCSManageButton->setIconSize(QSize(44,44));       //按下时放大icon大小
        ui->PCSManageButton->setFont(QFont("宋体",10,QFont::Bold));        //按下时更改字体格式：Qfont对象 字体 大小 加粗
        ui->PCSManageButton->setStyleSheet("QToolButton{background-color:rgb(0, 85, 127);color: rgb(255, 255, 255);}");
    }
    else
    {
        ui->PCSManageButton->setIconSize(QSize(40,40));
        ui->PCSManageButton->setFont(QFont("宋体",9,QFont::Bold));
...
void MainWindow::on_EMSManageButton_toggled(bool checked)
{
    if(checked)
    {
        ui->EMSManageButton->setIconSize(QSize(44,44));       //按下时放大icon大小
        ui->EMSManageButton->setFont(QFont("宋体",10,QFont::Bold));        //按下时更改字体格式：Qfont对象 字体 大小 加粗
        ui->EMSManageButton->setStyleSheet("QToolButton{background-color:rgb(0, 85, 127);color: rgb(255, 255, 255);}");
    }
    else
    {
        ui->EMSManageButton->setIconSize(QSize(40,40));
        ui->EMSManageButton->setFont(QFont("宋体",9,QFont::Bold));
...
void MainWindow::on_SystemDefenseButton_toggled(bool checked)
{
    if(checked)
    {
        ui->SystemDefenseButton->setIconSize(QSize(44,44));       //按下时放大icon大小
        ui->SystemDefenseButton->setFont(QFont("宋体",10,QFont::Bold));        //按下时更改字体格式：Qfont对象 字体 大小 加粗
        ui->SystemDefenseButton->setStyleSheet("QToolButton{background-color:rgb(0, 85, 127);color: rgb(255, 255, 255);}");
    }
    else
    {
        ui->SystemDefenseButton->setIconSize(QSize(40,40));
        ui->SystemDefenseButton->setFont(QFont("宋体",9,QFont::Bold));
...
void MainWindow::on_OtherDeviceButton_toggled(bool checked)
{
    if(checked)
    {
        ui->OtherDeviceButton->setIconSize(QSize(44,44));       //按下时放大icon大小
        ui->OtherDeviceButton->setFont(QFont("宋体",10,QFont::Bold));        //按下时更改字体格式：Qfont对象 字体 大小 加粗
        ui->OtherDeviceButton->setStyleSheet("QToolButton{background-color:rgb(0, 85, 127);color: rgb(255, 255, 255);}");
    }
    else
    {
        ui->OtherDeviceButton->setIconSize(QSize(40,40));
        ui->OtherDeviceButton->setFont(QFont("宋体",9,QFont::Bold));
...
void MainWindow::on_DataStatisticsButton_toggled(bool checked)
{
    if(checked)
    {
        ui->DataStatisticsButton->setIconSize(QSize(44,44));       //按下时放大icon大小
        ui->DataStatisticsButton->setFont(QFont("宋体",10,QFont::Bold));        //按下时更改字体格式：Qfont对象 字体 大小 加粗
        ui->DataStatisticsButton->setStyleSheet("QToolButton{background-color:rgb(0, 85, 127);color: rgb(255, 255, 255);}");
    }
    else
    {
        ui->DataStatisticsButton->setIconSize(QSize(40,40));
        ui->DataStatisticsButton->setFont(QFont("宋体",9,QFont::Bold));
...
void MainWindow::on_UserManageButton_toggled(bool checked)
{
    if(checked)
    {
        ui->UserManageButton->setIconSize(QSize(44,44));       //按下时放大icon大小
        ui->UserManageButton->setFont(QFont("宋体",10,QFont::Bold));        //按下时更改字体格式：Qfont对象 字体 大小 加粗
        ui->UserManageButton->setStyleSheet("QToolButton{background-color:rgb(0, 85, 127);color: rgb(255, 255, 255);}");
    }
    else
    {
        ui->UserManageButton->setIconSize(QSize(40,40));
        ui->UserManageButton->setFont(QFont("宋体",9,QFont::Bold));
...
{
    QPixmap pixmap = icon.pixmap(QSize(100,70));
